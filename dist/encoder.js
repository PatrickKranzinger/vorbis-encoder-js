...
(function(){
  var libvorbis, encoder_init, encoder_stream_init, encoder_clear, encoder_analysis_buffer, encoder_process, encoder_data_len, encoder_transfer_data, HEAPU8, HEAPU32, HEAPF32, ref$, keys, each, map, apply, at, Blob, encoder_set_tag, setTags, Encoder, slice$ = [].slice;
  ...
  module.exports = Encoder = (function(){
    ...
    Encoder.prototype.encodeFrom = function(audioBuffer){
      ...
      map(function(it){
        return audioBuffer.channelData[it];
      })(
      (function(){
        var i$, to$, results$ = [];
        for (i$ = 0, to$ = this.numChannels; i$ < to$; ++i$) {
    ...
    Encoder.prototype.finish = function(mimeType){
      ...
      blob = (function(){
        ...
        case typeof Blob === 'undefined':
          return new Blob(this.oggBuffers, {
